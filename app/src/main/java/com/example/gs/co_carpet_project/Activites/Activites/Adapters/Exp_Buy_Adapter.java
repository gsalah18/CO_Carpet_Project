...
public class Exp_Buy_Adapter extends BaseExpandableListAdapter {

    private Context context;
    private LinkedList<Buys_class>data;
    public Exp_Buy_Adapter(Context context, LinkedList<Buys_class>data) {
        super();
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final Buys_class Data=(Buys_class) getChild(groupPosition,childPosition);
        ...
        country.setText("الدوله:"+Data.getCountry());
        if(country.getText().toString().equals(""))
            ((ViewGroup)country.getParent()).removeView(country);

        TextView city=(TextView)convertView.findViewById(R.id.city);
        city.setText("المدينه:"+Data.getCity());
