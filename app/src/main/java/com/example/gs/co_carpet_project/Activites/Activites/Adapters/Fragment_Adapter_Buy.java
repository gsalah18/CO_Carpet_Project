...
public class Fragment_Adapter_Buy extends FragmentPagerAdapter {
    LinkedList<Buy_Frag>frags;
    LinkedList<String>titles;
    public Fragment_Adapter_Buy(FragmentManager fm, LinkedList<Buy_Frag>frags, LinkedList<String>titles) {
        super(fm);
        this.frags=frags;
        this.titles=titles;
    }
